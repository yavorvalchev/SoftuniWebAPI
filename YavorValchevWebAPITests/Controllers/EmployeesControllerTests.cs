...
namespace YavorValchevWebAPI.Controllers.Tests
{
    ...
    public class EmployeesControllerTests
    {
        ...
        public void FilterEmployees_FiltersByDepartment()
        {
            ...
            var employeesController = new EmployeesController();
            var departmentEmployees = employeesController.FilterEmployees(employees, new Guid("20000000-0000-0000-0000-000000000000"), null);
        ...
        public void FilterEmployees_FiltersByCity()
        {
            ...
            var employees = new List<Employee>
            {
                new Employee{ Id=new Guid("11000000-0000-0000-0000-000000000000"), Address = new Address{ City="Sofia" } },
                new Employee{ Id=new Guid("12000000-0000-0000-0000-000000000000"), Address = new Address{ City="Sofia" } },
                new Employee{ Id=new Guid("21000000-0000-0000-0000-000000000000"), Address = new Address{ City="Plovdiv" } }
            };
            var employeesController = new EmployeesController();
